...
public class Torcherinoaemod {
    ...
    public Torcherinoaemod(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Register our DeferredRegisters for blocks, items and creative tab
        ModBlocks.BLOCKS.register(modEventBus);
        ModItems.ITEMS.register(modEventBus);
        ModCreativeTabs.CREATIVE_TABS.register(modEventBus);

        // Register ourselves for server and other game events we are interested in.
        // Note that this is necessary if and only if we want *this* class (Torcherinoaemod) to respond directly to events.
